...
public class ProjectOld extends Operator {
    ...
    public ProjectOld(Operator base, ArrayList<Attribute> as, int type) {
        super(type);
        this.base = base;
        this.attrset = as;
    }
    ...
    public Object clone() {
        ...
        ProjectOld newproj = new ProjectOld(newbase, newattr, optype);
