...
public class Project2 extends Operator {
    Operator base;
    int numBuff;
    boolean distinct;
    int batchSize;
    ...
    public Project2(Operator base, ArrayList<Attribute> attributes, boolean distinct, int optype, int numBuff) {
        super(optype);
    ...
    public Object clone() {
        ...
        Project2 newproj = new Project2(newbase, newattr, this.distinct, optype, this.numBuff);
